...
const logo = require('../img/morphene.png');
...
export default class Welcome extends Component {
  ...
  handleAuthorLink = () => {
    shell.openExternal('https://steemit.com/@netuoso');
  }
          ...
          <Grid.Column width={4} stretched>
            <Segment basic textAlign="center">
              ...
              <Header size="large">
                ...
                <Header.Subheader>
                  <p>
                    Desktop wallet for the Morphene Blockchain
                  </p>
                  <p>
                    Created by
                    {' '}
            ...
            <Segment basic padded>
              <Segment piled padded>
                <Header>
                  Getting Started
                  <Header.Subheader>
                    To get started with Hypnosis, an account must be added to the wallet.
                  </Header.Subheader>
                </Header>
