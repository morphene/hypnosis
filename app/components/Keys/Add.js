  ...
  render() {
    let display = (
      <Segment.Group>
        <Segment padded>
          <Header>
            Import a Morphene Blockchain account
            <Header.Subheader>
              By using your Morphene username and password, your private
        ...
        <Segment padded>
          <Header>
            ...
            <Header.Subheader>
              For advanced users.
              Create a new set of public and private keys for a new Morphene
