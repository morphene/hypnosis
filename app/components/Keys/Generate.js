    ...
    let display = (
      <div>
        <Header size="huge">
          ...
          <Header.Subheader>
            This feature is for advanced users with a deep understanding of Morphene.
          </Header.Subheader>
        </Header>
        <p>Create a new set of public and private keys for a new Morphene account.</p>
        <p>This is a multi-step process and requires either using a service or knowing another user to complete.</p>
        <ul>
          <li>Using Hypnosis, generate mnemonic phrase along with a set of keys.</li>
