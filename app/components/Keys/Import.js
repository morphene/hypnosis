...
export default class KeysImport extends Component {
  ...
  validate = (newState) => {
    ...
    errors.wif_error_invalid = !morpheneJS.auth.isWif(newState.wif);
    return errors;
  }
    ...
    if (encryptWallet) {
      ...
      encryptionWarning = (
        <Message
          ...
          content="The wallet password is only used to unlock Hypnosis during transactions. If you lose your password, you will be unable to recover your keys. Please make sure to back up your keys and remember your password."
        />
      );
    }
    let display = (
