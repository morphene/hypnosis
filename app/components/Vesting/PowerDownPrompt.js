...
class PowerDownPrompt extends Component {
  ...
  constructor(props) {
    ...
    const totalVestsMorph = parseFloat(props.morpheneJS.props.total_vesting_fund_morph.split(" ")[0])
    const totalVests = parseFloat(props.morpheneJS.props.total_vesting_shares.split(" ")[0])
    const sp = totalVestsMorph * vests / totalVests;
          ...
          content={
            ...
            >
              ...
              >
                    ...
                    <Grid.Column>
                      <Header textAlign="center" color="green" size="large">
                        <Header.Subheader>Estimated Weekly</Header.Subheader>
                          +{this.state.perWeek}
                        <Header.Subheader>MORPH</Header.Subheader>
                      </Header>
                    </Grid.Column>
                  </Grid.Row>
                </Grid>
                ...
                <Message
                  content="Drag the slider to adjust the amount of SP/VESTS to convert to MORPH over the next 13 weeks."
                />
                <Message
                  error
